...
function Card({ icon, name, type, createdBy, lastUpdated, action }) {
  ...
  return (
    <div className="card-container">
        ...
        <div className="card-action">
            <Button text={action} color="black-light" onClick={() => {}}/>
            <i class="bi bi-trash delete-icon" onClick={() => {console.log("deleted")}}></i>
        </div>
    </div>
  );
}
